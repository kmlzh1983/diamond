...
.list-dot li a.close,.list-dot-othors li a.close{ background: url("/diamond/statics/images/cross.png") no-repeat left 3px; display:block; width:16px; height:16px;position: absolute;outline:none;right:5px; bottom:5px}
    ...
    <div class="table_full">
  	...
  	<div class="form-actions">
           <button class="btn btn-primary btn_submit J_ajax_submit_btn"type="submit">提交</button>
      		<a class="btn" href="/diamond/index.php/Admin/Slide">返回</a>
      </div>
 </form>
</div>
										...
										button:[
											{
												...
												name: '返回列表',
												callback:function(){
													location.href="/diamond/index.php/Admin/Slide";
													return true;
												}
											}
										]
