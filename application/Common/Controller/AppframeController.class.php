...
class AppframeController extends Controller {
    ...
    protected function page($Total_Size = 1, $Page_Size = 0, $Current_Page = 1, $listRows = 6, $PageParam = '', $PageLink = '', $Static = FALSE) {
    	...
    	//$Page->SetPager('default','<div class="item-page"><ul class="pagination">共有 {recordcount} 条记录&nbsp;&nbsp;当前第&nbsp;{pageindex}&nbsp;页&nbsp;/&nbsp;共&nbsp;{pagecount}&nbsp;页&nbsp;{first}{prev}&nbsp;&nbsp;{list}&nbsp;&nbsp;{next}{last}&nbsp;&nbsp;转到&nbsp;{jump}&nbsp;页</div>',array("listlong"=>"6","first"=>"首页","last"=>"尾页","prev"=>"上一页","next"=>"下一页","list"=>"*","jump"=>"select"));
    	return $Page;
    }
    //分页
    protected function page_simple($Total_Size = 1, $Page_Size = 0, $Current_Page = 1, $listRows = 6, $PageParam = '', $PageLink = '', $Static = FALSE) {
    	import('Page');
    	if ($Page_Size == 0) {
    		$Page_Size = C("PAGE_LISTROWS");
    	}
    	...
    	$Page = new \Page($Total_Size, $Page_Size, $Current_Page, $listRows, $PageParam, $PageLink, $Static);
    	$Page->SetPager('default','<div class="pager"><ul class="items"><li>{prev}</li><li><span> <i class="current"> {pageindex} </i> /{pagecount}</span></li><li>{next}</li></ul></div>',array("listlong"=>"6","first"=>"首页","last"=>"尾页","prev"=>"◄","next"=>"►","list"=>"*","jump"=>"input"));
    	return $Page;
    }
