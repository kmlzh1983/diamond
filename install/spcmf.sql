...
CREATE TABLE `sp_supplier` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='供应商';

-- ----------------------------
-- Table structure for `sp_member_points`
-- ----------------------------
DROP TABLE IF EXISTS `sp_member_points`;
...
-- ----------------------------
-- Table structure for `sp_member_address`
-- ----------------------------
DROP TABLE IF EXISTS `sp_member_address`;
CREATE TABLE `sp_member_address` (
...
-- ----------------------------
-- Table structure for `sp_member_favorites`
-- ----------------------------
DROP TABLE IF EXISTS `sp_member_favorites`;
CREATE TABLE `sp_member_favorites` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sp_member` (
  ...
  `constellation` smallint(1) NOT NULL COMMENT '星座',
  `address` varchar(255) NOT NULL COMMENT '居住地',
...
-- ----------------------------
-- Table structure for `sp_goods_posts`
-- ----------------------------
DROP TABLE IF EXISTS `sp_goods_posts`;
CREATE TABLE `sp_goods_posts` (
  `goods_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `posts_id` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `admin_id` tinyint(3) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`goods_id`,`posts_id`,`admin_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for `sp_link_goods`
-- ----------------------------
...
CREATE TABLE `sp_order` (
  ...
  `money_goods` decimal(10,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '商品总价格',
  `money_total` decimal(10,2) unsigned NOT NULL DEFAULT '0.00',
  ...
  `package_fee` decimal(10,2) unsigned DEFAULT '0.00',
  `card_fee` decimal(10,2) unsigned DEFAULT '0.00' COMMENT '贺卡费用',
  ...
  `receipt_type` varchar(20) DEFAULT '0',
  `receipt_head` varchar(50) DEFAULT '0',
  `receipt_content` varchar(255) DEFAULT '0',
  `package_id` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '包装类型',
  ...
  `shipping_id` tinyint(2) unsigned NOT NULL DEFAULT '1' COMMENT '快递id',
  `shipping_name` varchar(100) NOT NULL DEFAULT '中通快递' COMMENT '快递名称',
  `shipping_sn` varchar(50) NOT NULL COMMENT '运单号',
  `shipping_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '发货时间',
  `message` varchar(255) DEFAULT NULL COMMENT '买家留言',
  `message_admin` varchar(255) DEFAULT NULL,
  `receive_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '收获时间',
  `how_oos` varchar(50) NOT NULL DEFAULT '等待所有商品备其后再发',
  `card_id` tinyint(1) unsigned DEFAULT '0' COMMENT '贺卡类型',
  `card_name` varchar(20) DEFAULT NULL,
  `card_message` varchar(255) DEFAULT NULL COMMENT '贺卡留言内容',
  `is_insure` tinyint(1) unsigned DEFAULT '0' COMMENT '是否保价',
  `ref` varchar(20) DEFAULT '本站',
...
CREATE TABLE `sp_order_goods` (
  ...
  `money_goods` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '价格',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=95 DEFAULT CHARSET=utf8;
-- ----------------------------
-- Table structure for `sp_goods_gallery`
-- ----------------------------
...
-- ----------------------------
-- Table structure for `sp_type_attr`
-- ----------------------------
DROP TABLE IF EXISTS `sp_type_attr`;
CREATE TABLE `sp_type_attr` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sp_brand` (
  ...
  `status` int(2) DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='品牌';
...
CREATE TABLE `sp_goods` (
  ...
  `bigimage` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `smallimage` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `content` text,
  ...
  `supplier_id` decimal(11,2) DEFAULT NULL,
  `stock` int(11) DEFAULT '0',
  `seo_title` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  ...
  `picprefix` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `piece` int(11) DEFAULT NULL,
  `status` int(2) NOT NULL DEFAULT '1',
  `modify_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
  KEY `pid` (`id`) USING BTREE,
  KEY `classid` (`cate_id`) USING BTREE,
  KEY `product_name` (`name`) USING BTREE,
  KEY `isnew` (`isnew`) USING BTREE,
  KEY `ishot` (`ishot`) USING BTREE,
  KEY `isrec` (`isrec`) USING BTREE,
  KEY `isprice` (`isprice`) USING BTREE,
  KEY `dateline` (`create_date`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
...
-- 
-- 表的结构 `sp_comments_goods`
-- 

CREATE TABLE `sp_comments_goods` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `post_table` varchar(100) NOT NULL COMMENT '评论内容所在表，不带表前缀',
  `post_id` int(11) unsigned NOT NULL DEFAULT '0',
  `url` varchar(255) DEFAULT NULL COMMENT '原文地址',
...
INSERT INTO `sp_auth_rule` VALUES ('158', 'Admin', 'admin_url', 'admin/goods/default', null, '商品管理', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('159', 'Admin', 'admin_url', 'admin/goods/index', null, '商品列表', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('160', 'Goods', 'admin_url', 'goods/admingoods/index', null, '商品列表', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('161', 'Goods', 'admin_url', 'goods/admingoodstype/index', null, '商品分类', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('162', 'Goods', 'admin_url', 'goods/brand/index', null, '品牌管理', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('163', 'Goods', 'admin_url', 'goods/adminbrand/index', null, '品牌管理', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('164', 'Goods', 'admin_url', 'goods/admingoodscat/index', null, '商品分类', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('165', 'Admin', 'admin_url', 'admin/admintype/index', null, '商品类型', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('166', 'Goods', 'admin_url', 'goods/admintype/index', null, '商品类型', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('167', 'Goods', 'admzin_url', 'goods/admincate/index', null, '商品分类', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('168', 'Admin', 'admin_url', 'admin/order/default', null, '订单管理', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('169', 'Admin', 'admin_url', 'admin/order/index', null, '订单管理', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('170', 'Order', 'admin_url', 'order/order/index', null, '订单管理', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('171', 'Order', 'admin_url', 'order/adminorder/index', null, '订单管理', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('172', 'Order', 'admin_url', 'order/adminorder/default', null, '订单管理', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('173', 'Order', 'admin_url', 'order/adminorder/search', null, '订单查询', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('174', 'Goods', 'admin_url', 'goods/admingoods/recyclebin', null, '商品回收', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('175', 'User', 'admin_url', 'user/rank/index', null, '用户等级', '1', '');
INSERT INTO `sp_auth_rule` VALUES ('176', 'User', 'admin_url', 'user/adminrank/index', null, '用户等级', '1', '');
-- 
-- 导出表中的数据 `sp_links`
-- 
...
INSERT INTO `sp_menu` VALUES ('158', '0', 'Admin', 'Goods', 'default', '', '0', '1', '商品管理', 'reorder', '', '25');
INSERT INTO `sp_menu` VALUES ('159', '158', 'Goods', 'AdminGoods', 'index', '', '1', '1', '商品列表', '', '', '0');
INSERT INTO `sp_menu` VALUES ('160', '158', 'Goods', 'AdminCate', 'index', '', '1', '1', '商品分类', '', '', '0');
INSERT INTO `sp_menu` VALUES ('161', '158', 'Goods', 'AdminBrand', 'index', '', '1', '1', '品牌管理', '', '', '0');
INSERT INTO `sp_menu` VALUES ('162', '158', 'Goods', 'AdminType', 'index', '', '1', '1', '商品类型', '', '', '0');
INSERT INTO `sp_menu` VALUES ('163', '0', 'Order', 'AdminOrder', 'default', '', '1', '1', '订单管理', '', '', '0');
INSERT INTO `sp_menu` VALUES ('164', '163', 'Order', 'AdminOrder', 'index', '', '1', '1', '订单列表', '', '', '0');
INSERT INTO `sp_menu` VALUES ('165', '163', 'Order', 'AdminOrder', 'search', '', '1', '1', '订单查询', '', '', '0');
INSERT INTO `sp_menu` VALUES ('166', '158', 'Goods', 'AdminGoods', 'recyclebin', '', '1', '1', '商品回收', '', '', '0');
INSERT INTO `sp_menu` VALUES ('167', '133', 'User', 'AdminRank', 'index', '', '1', '1', '用户等级', 'leaf', '', '0');
-- --------------------------------------------------------
